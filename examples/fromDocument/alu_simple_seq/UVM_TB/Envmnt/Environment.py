...
from ALUScoreboard import ALUScoreboard
...
from alu_agent import Agent as ALUAgent
...
class Environment(uvm_env):
    ...
    def build_phase(self):
        ...
        self.scoreboard = ALUScoreboard('ALUcoreboard', self)
        ...
        self.agent = ALUAgent('ALUAgent', self)
    ...
    def _import_refmdl(self):
        ...
        implementation_class = config.uvm_components.refmdl.alu_refmdl_impl
