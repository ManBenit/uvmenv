...
from WriteSequence import WriteSequence
...
class Test(uvm_test):
    def build_phase(self):
        ...
        self.wseq = WriteSequence('WriteSequence')
        self.rseq = ReadSequence('ReadSequence')
    ...
    async def run_phase(self):
        ...
        """
        await self.wseq.start(self.env.agent.seqr)
        await self.rseq.start(self.env.agent.seqr)
