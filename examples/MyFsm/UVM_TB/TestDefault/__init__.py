...
class TestDefault(uvm_test):
    def build_phase(self):
        ...
        self.seqd = SeqDirected('SeqDirected')
        self.seqd1 = SeqDirected1('SeqDirected1')
    ...
    async def run_phase(self):
        ...
        await self.seqd.start(self.env.agent.seqr)
        await self.seqd1.start(self.env.agent.seqr)
