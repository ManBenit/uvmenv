...
from Directed1Sequence import Directed1Sequence
...
class Test(uvm_test):
    def build_phase(self):
        ...
        self.dseq = DirectedSequence('DirectedSequence')
        self.dseq1 = Directed1Sequence('Directed1Sequence')
    ...
    async def run_phase(self):
        ...
        """
        await self.dseq.start(self.env.agent.seqr)
        await self.dseq1.start(self.env.agent.seqr)
