            ...
            if not success_dut or not success_rmod:
                ...
                if self.enable_scoreboarding:  
                    try:
                        ...
                        ## Save conditions
                        result_cond = response_dut.resul_o == response_rmod.resul_o

                        # Make assertions
                        assert result_cond, f'TEST FAILED result_signal_1 dut({hex(response_dut.resul_o)}), rmod({hex(response_rmod.resul_o)})'
