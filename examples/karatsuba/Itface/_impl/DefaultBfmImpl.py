...
class DefaultBfmImpl(BFM):
    ...
    async def set(self, *, num1_i,num2_i):
        ...
        self.dut.num1_i.value = num1_i
        self.dut.num2_i.value = num2_i
    ...
    async def get(self):
        ins = {
            'num1_i': self.dut.num1_i.value,
            'num2_i': self.dut.num2_i.value
        }

        outs = {
            'resul_o': self.dut.resul_o.value
        }
