...
will update `UVMEnv` repository ans its main dependencies (
    ...
    [Cocotb](https://github.com/cocotb/cocotb) and
...
- [`command_files`](https://github.com/ManBenit/uvmenv/blob/uvmenv-2.0/docs/files_classification/functionality/base_commands.md) directory.
- [`component_files`](https://github.com/ManBenit/uvmenv/blob/uvmenv-2.0/docs/files_classification/functionality/base_components.md) directory.
- [`config_files`](https://github.com/ManBenit/uvmenv/blob/uvmenv-2.0/docs/files_classification/functionality/base_configurations.md) directory.
- [`representative_iles`](https://github.com/ManBenit/uvmenv/blob/uvmenv-2.0/docs/files_classification/functionality/base_representatives.md) directory.
