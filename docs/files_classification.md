...
<p align="center">
  <img src="https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/img/mainHierarchy.png" 
    alt="Main UVMEnv hierarchy" 
    width="70%" 
  />
  <img src="https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/img/directoryTree.png" 
...
is generated, it will run correctly (See the [generic testbench](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/generic_tb.md)).
...
[main structure](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/main_structure.md) ilustrates.
...
- [Commands](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/files_classification/functionality/base_commands.md).
- [Components](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/files_classification/functionality/base_components.md).
- [Configurations](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/files_classification/functionality/base_configurations.md).
- [Representatives](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/files_classification/functionality/base_representatives.md).
...
- [Base created](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/files_classification/malleability/base_created.md).
- [Fully created](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/files_classification/malleability/fully_created.md).
- [Partially created](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/files_classification/malleability/partially_created.md).
