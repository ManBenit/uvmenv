...
[base components](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/usr_itface.md)
)
...
(see [base files commands](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/files_classification/functionality/base_commands.md)).
...
[Here details of main signals getting](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/files_classification/functionality/base_commands.md)
