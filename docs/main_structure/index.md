...
- Clear 
  [directories](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/files_classification.md) 
  and 
  [files](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/dirs_classification.md) 
  classification, according to different UVM concepts and implemented characteristics.


- Full use of 
  [TLM communication](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/main_structure/tlm_communication.md) 
...
[here](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/main_structure/extra/index.md).
...
[class diagram](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/main_structure/uvmenv_class_diagram.md).
...
<p align="center">
  <img src="https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/img/mainDirectories.png" 
    alt="Directory tree"
    width="70%" 
  />
</p>
