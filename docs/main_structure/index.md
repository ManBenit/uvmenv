...
- Clear 
  [directories](https://github.com/ManBenit/uvmenv/blob/uvmenv-2.0/docs/files_classification.md) 
  and 
  [files](https://github.com/ManBenit/uvmenv/blob/uvmenv-2.0/docs/dirs_classification.md) 
  classification, according to different UVM concepts and implemented characteristics.


- Full use of 
  [TLM communication](https://github.com/ManBenit/uvmenv/blob/uvmenv-2.0/docs/main_structure/tlm_communication.md) 
...
[here](https://github.com/ManBenit/uvmenv/blob/uvmenv-2.0/docs/main_structure/extra/index.md).
...
[class diagram](https://github.com/ManBenit/uvmenv/blob/uvmenv-2.0/docs/main_structure/uvmenv_class_diagram.md).
