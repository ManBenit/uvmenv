...
[user interface](https://github.com/ManBenit/uvmenv/blob/uvmenv-1.0/docs/usr_itface.md), in general steps for this creation are described by the next diagram:
